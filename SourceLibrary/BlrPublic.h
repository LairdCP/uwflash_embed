...
** Module:      BLRPUBLIC.H
**
** Notes:       For different platforms and implementations, only BlrPublic.h
**              is transferred. This ensures that the Firmware service module
**              Frm will always be satisfied.
**
*******************************************************************************/
