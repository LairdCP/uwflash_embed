...
#if !defined(_TBOOTLDRBL65X_H)     /* prevent multiple inclusions */
#define _TBOOTLDRBL65X_H
...
#define BL65X_NORMAL_MODE_BAUDRATE              (115200)
#define BL65X_FLASHUPLOAD_MODE_BAUDRATE         (115200)
...
class TBootLdrBL65X : public TBootLdrProtV3
{
//Data
private:
